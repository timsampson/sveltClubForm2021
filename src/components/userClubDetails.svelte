...
<div>
  {#if $userDetails.isInClub === undefined}
    <h1
      class="text-center text-white rounded-md p-2 my-2 mx-auto md:max-w-2xl bg-gradient-to-r from-indigo-300 to-indigo-500"
    >
      Please wait for the club details to load.
    </h1>
  {:else if $userDetails.isInClub}
    <h1
      class="text-center text-white rounded-md p-2 my-2 mx-auto md:max-w-2xl bg-gradient-to-r from-red-300 to-red-500"
    >
  ...
  {:else}
    <h1
      class="text-center text-white rounded-md p-2 my-2 mx-auto md:max-w-2xl bg-gradient-to-r from-green-300 to-green-500"
    >
